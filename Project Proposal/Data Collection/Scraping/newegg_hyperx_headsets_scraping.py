...
base_url = "https://www.newegg.com/p/pl?N=50011776&d=hyperx+gaming+headset&PageSize=96"
...
headers = {
    ...
    "Referer": "https://www.newegg.com/p/pl?N=50011776&d=hyperx+gaming+headset&PageSize=96",
    ...
    if response.status_code == 200:
        ...
        for product in products:  
            ...
            if link_tag:
                ...
                if "refurbished" in title.lower() or "replacement" in title.lower() or "used" in title.lower() or "condenser" in title.lower() or "eyewear" in title.lower() or "parent" in title.lower():
...
with open('hyperx_product_links.json', 'w') as f:
...
for index, product in enumerate(product_data, start=1): 
    ...
    try: 
        ...
        if response.status_code == 200:
            ...
            if index % 10 == 0:
                with open('hyperx_product_data.json', 'w', encoding="utf-8") as f:
